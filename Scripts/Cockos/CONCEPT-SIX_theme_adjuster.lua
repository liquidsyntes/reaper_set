...
-- 1.08  |  updated (tcp: meterflip opt., tcp: show-hide polarity, tcp: sepSends opt., tcp: custom button opt.)
-------------------------------------------------------
...
---
palette.CSIX = {{93,52,93},{53,93,93},{92,133,133},{103,152,204},{102,102,102},{204,205,153},{153,154,102},{102,101,153},{53,91,133},{64,60,156}}
...
function ParamRow:new(parent,valsTable,rowIdx)
  local o = {}
  self.__index = self
  if (rowIdx%2==0) then rowBgCol = {50,59,68} else rowBgCol = {0,0,0,25} end --- bg scheme color (theme -- fill rows global)
...
function switchTheme()
  local str = string.match(reaper.GetLastColorThemeFile(), '^(.*)[/\\].+$')
    if(reaper.file_exists(str.."/CONCEPT-SIX2-BASIC_unpacked.ReaperTheme")==true) then
        ...
        else if(reaper.file_exists(str.."/CONCEPT-SIX2-BASIC-Narrow_unpacked.ReaperTheme")==true) then
                openTheme = reaper.OpenColorThemeFile(str.."/CONCEPT-SIX2-BASIC-Narrow_unpacked.ReaperTheme")
            else if(reaper.file_exists(str.."/CONCEPT-SIX2-BASIC-Narrow.ReaperThemeZip")==true) then
                    openTheme = reaper.OpenColorThemeFile(str.."/CONCEPT-SIX2-BASIC-Narrow.ReaperThemeZip")
...
meterFlipVals = {'ALWAYS','60','130','220','320','420','600','NEVER'}
mcpStripVolVals = {'KNOB',75,110,270,370} --- concept-six (strips volume size)
mcpFxEmbedVals = {'DEFAULT',100,200,300,400,500,'600 (MAX)'} --- concept-six (mcp fxembed size)
mcpFxEmbedMainVals = {'DEFAULT',150,200,300,400,500,'600 (MAX)'} --- concept-six (mcp master fxembed size)
tcpCustomButtonVals = {400,600,800,'ALWAYS'} --- concept-six (tcp hide custom button)
...
helpR_help = 'CONCEPT SIX Theme Adjuster 1.08'
...
apply = {}
root = Element:new(nil, {x=0,y=0,drawx=0,drawy=0,w=_gfxw,h=_gfxh,color={50,59,68}}) -- 38,38,38 -- fill theme
...
Spinner:new(_pageTrack_und, {x=348,y=6,w=155,title='HIDE ACTIONS',action=paramSet,param='tcp_customButton',valsTable=tcpCustomButtonVals}) --- concept-six
Button:new(_pageTrack_und, {x=281,y=39,w=30,img='Check-buttons_check',imgType=3,action=actionToggle,param=40302}) --- concept-six
Element:new(_pageTrack_und, {x=304,y=40,w=104,h=30,text={str='SHOW FX INSERTS',style=2,align=4,col={169,169,170}}})
Button:new(_pageTrack_und, {x=406,y=39,w=30,img='Check-buttons_check',imgType=3,action=actionToggle,param=40677}) --- concept-six
Element:new(_pageTrack_und, {x=429,y=40,w=104,h=30,text={str='SHOW SENDS',style=2,align=4,col={169,169,170}}})

_layoutTrackStroke = Element:new(_pageTrack_und, {x=0,y=153,w=513,h=496,color={253,253,253,40}}) -- stroke
...
_applyStroke_Track = Element:new(_pageTrack_und, {x=274,y=70,w=239,h=83,color={253,253,253,40}}) -- stroke
_applyBox_Track = Element:new(_applyStroke_Track, {x=1,y=1,w=237,h=83,color={50,59,68},helpL=helpL_applySize}) -- fill
Element:new(_applyStroke_Track, {x=17,y=16,w=205,h=67,color={0,0,0,25},helpL=helpL_applySize}) -- fill
apply.und = {tcp={Button:new(_applyBox_Track, {x=54,y=25,w=61,img='apply_100',imgType=3,action=applyLayout,param={'tcp',''},helpR=helpR_applySize,helpL=helpL_applySize})}}
apply.und.tcp[2] = Button:new(_applyBox_Track, {x=1090,y=25,w=61,img='apply_150',imgType=3,action=applyLayout,param={'tcp','150%_'},helpR=helpR_applySize,helpL=helpL_applySize}) --- concept-six (no dpi scale)
apply.und.tcp[3] = Button:new(_applyBox_Track, {x=115,y=25,w=61,img='apply_200',imgType=3,action=applyLayout,param={'tcp','200%_'},helpR=helpR_applySize,helpL=helpL_applySize}) --- concept-six (no dpi scale) ORG 151,y=29,w=61
Element:new(_applyBox_Track, {x=17,y=60,w=200,h=10,img='apply_to_sel'})

--- concept-six (no left meters)
_layoutTrack = Element:new(_layoutTrackStroke, {x=1,y=1,w=511,h=494,color={50,59,68},helpL=helpL_layout}) -- fill
...
Spinner:new(_layoutTrack, {x=353,y=19,w=129,title='SEP. SENDS',action=paramSet,param='tcp_sepSends',valsTable=seperateSendsVals,helpL=helpL_layout}) --- concept-six (Sendslist)
Spinner:new(_layoutTrack, {x=353,y=66,w=129,title='METER FLIP',action=paramSet,param='tcp_meterFlip',valsTable=meterFlipVals,helpL=helpL_layout}) --- concept-six (Sendslist)
...
tcpTableVals = {img = 'cell_hide',
                ...
                rows = {{param='tcp_Record_Arm',text={str='Record Arm '}},
                        ...
                        {param='tcp_Phase',text={str='Phase Invert'}},
...
_applyStroke_Mixer = Element:new(_pageMixer_und, {x=274,y=70,w=239,h=83,color={253,253,253,40},helpL=helpL_applySize}) -- stroke
_applyBox_Mixer = Element:new(_applyStroke_Mixer, {x=1,y=1,w=237,h=83,color={50,59,68},helpL=helpL_applySize}) -- fill
Element:new(_applyStroke_Mixer, {x=17,y=16,w=205,h=67,color={0,0,0,25},helpL=helpL_applySize}) -- fill
...
apply.und.mcp[2] = Button:new(_applyBox_Mixer, {x=1090,y=25,w=61,img='apply_150',imgType=3,action=applyLayout,param={'mcp','150%_'},helpR=helpR_applySize,helpL=helpL_applySize}) --- concept-six (no dpi scale) ORG x=90,y=29,w=61
apply.und.mcp[3] = Button:new(_applyBox_Mixer, {x=115,y=25,w=61,img='apply_200',imgType=3,action=applyLayout,param={'mcp','200%_'},helpR=helpR_applySize,helpL=helpL_applySize}) --- concept-six (no dpi scale) ORG 151,y=29,w=61
...
Spinner:new(_mixerTop, {x=62,y=10,w=185,title='ADD BORDER',action=paramSet,param='mcp_border',valsTable=mcpBorderVals,helpR=helpR_borders})
...
Element:new(_extMixerf, {x=29,y=9,w=190,h=30,text={str='Extended Mixer Controls#when size permits',style=2,align=4,col={169,169,170}}})
Button:new(_extMixerf, {x=23,y=45,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40549}) --- concept-six
Element:new(_extMixerf, {x=50,y=45,w=190,h=30,text={str='Show FX Inserts',style=2,align=4,col={169,169,170}}})
Button:new(_extMixerf, {x=23,y=78,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40910}) --- concept-six
Element:new(_extMixerf, {x=50,y=78,w=190,h=30,text={str='Show FX Parameters',style=2,align=4,col={169,169,170}}})
Button:new(_extMixerf, {x=48,y=98,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=41829}) --- concept-six - group fx parm
Element:new(_extMixerf, {x=74,y=98,w=190,h=30,text={str='Group with their Inserts',style=2,align=4,col={169,169,170}}})
Button:new(_extMixerf, {x=23,y=126,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40557}) --- concept-six
Element:new(_extMixerf, {x=50,y=126,w=190,h=30,text={str='Show Sends',style=2,align=4,col={169,169,170}}})
Button:new(_extMixerf, {x=48,y=146,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40267}) --- concept-six - group sends
Element:new(_extMixerf, {x=74,y=146,w=190,h=30,text={str='Group below/after Inserts',style=2,align=4,col={169,169,170}}})

_parmMixer = Element:new(_mLower, {x=256,y=1,w=256,h=190,color={50,59,68},helpL=help_pref}) -- fill
Button:new(_parmMixer, {x=29,y=9,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40371}) --- concept-six
Element:new(_parmMixer, {x=58,y=9,w=190,h=30,text={str='Show Multiple-Row Mixer#when size permits',style=2,align=4,col={169,169,170}}})
Button:new(_parmMixer, {x=29,y=45,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40221}) --- concept-six
Element:new(_parmMixer, {x=58,y=45,w=190,h=30,text={str='Scroll to Selected Track',style=2,align=4,col={169,169,170}}})
Button:new(_parmMixer, {x=29,y=78,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40903}) --- concept-six
Element:new(_parmMixer, {x=58,y=78,w=190,h=30,text={str='Show Icons',style=2,align=4,col={169,169,170}}})
Button:new(_parmMixer, {x=29,y=111,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=40389}) --- concept-six
Element:new(_parmMixer, {x=58,y=111,w=190,h=30,text={str='Show Master on right side',style=2,align=4,col={169,169,170}}})
Button:new(_parmMixer, {x=54,y=131,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=41610}) --- concept-six
Element:new(_parmMixer, {x=78,y=131,w=190,h=30,text={str='Toggle in dock',style=2,align=4,col={169,169,170}}})
Button:new(_parmMixer, {x=54,y=151,w=30,img='Check-buttons_check_blue',imgType=3,action=actionToggle,param=41636}) --- concept-six
Element:new(_parmMixer, {x=78,y=151,w=190,h=30,text={str='Toggle in separate window',style=2,align=4,col={169,169,170}}})
...
Element:new(_pageColor_und, {x=315,y=578,w=208,h=30,text={str='Rodilab Color palette (ReaPack add-on)',style=2,align=4,col={169,169,170}}})
...
apply.und.trans = {Button:new(_pageEnvTrans_und, {x=186,y=318,w=61,img='apply_100',imgType=3,action=applyLayout,param={'trans',''},helpL=helpL_applySize})}
...
apply.und.trans[3] = Button:new(_pageEnvTrans_und, {x=270,y=318,w=61,img='apply_200',imgType=3,action=applyLayout,param={'trans','200%_'},helpL=helpL_applySize})
